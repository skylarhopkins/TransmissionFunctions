...
for (k in 1:length(ks)) {
  ...
  write.csv(compareests, paste("/Users/hopkins/Documents/Transmission Function Literature Review/TransmissionFunctions/N1000compareests","K",ks[k],"FOI",FOI,"gamma",gamma,".csv",sep=""), row.names=F)
  #gc()
}
end_time <- Sys.time()
end_time - start_time 
